                    ...
                    <div class="col-lg-8 col-md-10 col-sm-12 mx-auto">
                        ...
                        <div class="card card-body login-card">
                            ...
                            <div class="form-group my-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="name" id="name" value="{{ old('name') }}" class=" form-control bg-transparent border-0 shadow-none" required placeholder="Full name....."/>
                                </div>
                            </div>
                            <hr/>
                            <div class="form-group my-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="designation" id="designation" value="{{ old('designation') }}" class=" form-control bg-transparent border-0 shadow-none" required  placeholder="Designation....."/>
                                </div>
                            </div>
                            <hr/>
                            <div class="form-group my-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="email" name="email" id="email" value="{{ old('email') }}" class=" form-control bg-transparent border-0 shadow-none" required  placeholder="Email address....."/>
                                </div>
                            </div>
                            <hr/>
                            <div class="form-group my-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" name="phone" id="phone" value="{{ old('phone') }}" class=" form-control bg-transparent border-0 shadow-none" required placeholder="Phone number....."/>
                                </div>
                            </div>
                            <hr/>
                            {{--<div class="form-group my-3 row">--}}
                            ...
                            <div class="form-group my-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="password" name="password" id="password" value="{{ old('password') }}" class=" form-control bg-transparent border-0 shadow-none" required placeholder="Password....."/>
                                </div>
                            </div>
                            <hr/>
                            <div class="form-group my-3 row">
                                ...
                                <div class="col-sm-9">
                                    <input type="password" name="password_confirmation" value="{{ old('password_confirmation') }}" id="confirmPassword" class=" form-control bg-transparent border-0 shadow-none" required  placeholder="Comfirm Password....."/>
                                </div>
                            </div>
                            <hr/>
